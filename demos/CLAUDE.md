...
```bash
node check-molecules.js && node tools/check-docs.js && node tools/check-pages.js && node tools/check-residues.js && node massaction/check-massaction.js && node diffusion/check-diffusion.js && node coupling/check-coupling.js
```
