...
(function (global) {
  ...
  /* Each row is [question, the concepts it needs, rank].
  ...
  const QUESTIONS = [
    ['Why do oil and water separate, if separating makes things more ordered?', ['water','hydrophob','entropy'], 1],
    ...
    ['Why do recipes change at altitude?',                     ['water','entropy'], 2],
    ['How are fizzy drinks made?',                             ['water','solvation','diffusion'], 2],
    ['Why are snowflakes six-sided?',                          ['crystal','water'], 1],
    ...
    ['How do salmon cross from salt water to fresh?',          ['osmosis','membrane'], 1],
    ...
    ['How high can a tree grow?',                               ['osmosis','water'], 2],
    ...
    ['Why do sprinters&#8217; legs burn at 200m but marathoners&#8217; don&#8217;t?', ['ferment','glycolys'], 1],
    ...
    ['Why is one reaction enough to build all four polymers?',  ['macromol','bonds','water'], 1],
    ['Why isn&#8217;t the mutation rate zero?',                ['dna','binding','enzyme'], 2],
    ['What holds the two strands together, and why that strength?', ['dna','bonds','water'], 1],
    ...
    ['Why is a polymer built by removing water, and taken apart by adding it?', ['macromol','water','bonds'], 1],
    ['Why can you digest starch but not cellulose, when both are only glucose?', ['macromol','shape','enzyme'], 1],
    ['Why are there four classes of macromolecule and not forty?', ['macromol','bonds','dna'], 2],
    ...
    ['Why does the helix twist, instead of lying flat like a ladder?', ['dna','water','bonds'], 3],
    ['Why do the two strands run in opposite directions?', ['dna','shape','enzyme'], 3],
  ...
  global.QuestionBank = { CONCEPTS, QUESTIONS };
})(this);
