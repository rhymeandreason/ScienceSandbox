 ...
 * provenance or units.
 *   The list is EMPTY today: the library is one scale family. The machinery
 * stays because the next either/or pair is a `units:` decision away, and
 * because an empty loop is cheaper than rediscovering why the suffix scheme
 * existed.
 *
