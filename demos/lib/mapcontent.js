...
(function (global) {
  ...
  const MODULES = [
    ...
    { id:'hbond', name:'Hydrogen bonding', door:'water', rank:1, state:'built', host:'water-lab',
      claim:'The + H of one water molecule attracts the − O of another.' },
    { id:'solvation', name:'Solvation', door:'water', rank:1, state:'built', host:'water-lab · solvation-lab',
      claim:'Water is polar, so it dissolves anything polar or charged.' },
    { id:'ice', name:'Ice & density', door:'water', rank:2, state:'built', host:'water-lab',
      claim:'Unlike almost every substance, water is less dense as a solid.' },
    { id:'heat', name:'Heat & temperature', door:'water', rank:2, state:'built', host:'water-lab',
      claim:'Water takes a lot of heating, because the energy goes into breaking H-bonds first.' },
    { id:'cohesion', name:'Cohesion & adhesion', door:'water', rank:2, state:'engine', host:'droplet-test · adhesion-test',
      claim:'Water sticks to itself and to other things.' },
    { id:'hydrophob', name:'The hydrophobic effect', door:'water', rank:1, state:'planned',
  ...
  const QUESTIONS = [
    ['How does pushing molecules together build a structure?',  { polarity:2, hydrophob:1 }],
    ['Why is water bent and CO₂ straight?',                     { polarity:2, hbond:3, geometry:1, covalent:2 }],
    ['Why do oil and water not mix?',                           { polarity:1, solvation:1, hydrophob:1, bilayer:2 }],
    ['Why does salt dissolve but sand doesn’t?',                { polarity:2, solvation:1, ionic:1 }],
    ...
    ['Why do recipes change at altitude?',                      { heat:1 }],
    ['Why is a fever above 40°C dangerous?',                    { heat:3, enzyme:2, denature:1 }],
    ...
    ['Why is a polymer built by removing water?',               { polymers:2 }],
