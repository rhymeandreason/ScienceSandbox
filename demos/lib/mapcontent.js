...
(function (global) {
  ...
  const MODULES = [
    ...
    { id:'ice', name:'Ice & density', door:'water', rank:1, state:'built', host:'water-lab',
      claim:'Unlike almost every substance, water is less dense as a solid.' },
    { id:'heat', name:'Heat & temperature', door:'water', rank:1, state:'built', host:'water-lab',
    ...
    { id:'cohesion', name:'Cohesion & adhesion', door:'water', rank:2, state:'engine', host:'droplet-test · adhesion-test',
      claim:'Water sticks to itself and to other things, hard enough to hang a column from a treetop.' },
  ...
  const QUESTIONS = [
    ['Why is water bent and CO₂ straight?',                     { polarity:1, hbond:1, geometry:1, covalent:2 }],
    ['Why do oil and water separate?',                          { polarity:1, solvation:1, hydrophob:1, bilayer:2 }],
    ['Why does salt dissolve but sand doesn’t?',                { polarity:2, solvation:1, ionic:1 }],
    ['Why does a bond form at all?',                            { polarity:3, entropy:2, covalent:1 }],
